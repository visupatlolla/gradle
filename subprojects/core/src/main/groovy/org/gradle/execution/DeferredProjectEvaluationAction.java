 ...
 */
public class DeferredProjectEvaluationAction implements BuildConfigurationAction {

    private final ProjectEvaluationConfigurer evaluationConfigurer;

    public DeferredProjectEvaluationAction(ProjectEvaluationConfigurer evaluationConfigurer) {
        this.evaluationConfigurer = evaluationConfigurer;
    }
    ...
    public void configure(BuildExecutionContext context) {
        ...
        //most below is copied over from the TaskSelector
        for (String path : taskNames) {
            if (path.contains(Project.PATH_SEPARATOR)) {
                ...
                evaluationConfigurer.evaluateNow(project.getPath());
            } else {
                for (Project sub : project.getSubprojects()) {
                    evaluationConfigurer.evaluateNow(sub.getPath());
                }
            }
        }
        context.proceed();
